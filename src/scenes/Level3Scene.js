class Level3Scene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.audio("world-3", "assets/sounds/world-3.mp3");
  ...
  create() {
    ...
    this.physics.add.collider(this.player, this.spikes, playerHit3, null, this);
    ...
    this.physics.add.overlap(this.player, exitLayer, startLevel4, null, this);
    ...
    this.physics.add.collider(this.player, bombs, playerHit3, null, this);
